...
def get_all_phrases_containing_tar_wrd(target_word, tar_passage, left_margin=30, right_margin=30):
    """
...
for word in data_reproducibility_keywords:
    ...
    # sentences because it is two column text. See whether pdf2text has a workaround parameter around this.
